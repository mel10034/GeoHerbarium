...
import 'package:geolog/layers/presentation/notifiers/common/edit_plant_notifier.dart';
...
class EditPLantPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => EditPlantNotifier(plant),
      child: const SubEditPlantPage(),
    );
  }
}

class SubEditPlantPage extends StatelessWidget {
  const SubEditPlantPage({super.key});
...
class MapPoint extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final notifier = context.watch<EditPlantNotifier>();
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
              ...
              border: OutlineInputBorder(
                  ...
                  borderSide: BorderSide(color: Colors.grey[850] as Color)),
              ...
              hintText:
                  notifier.country.isNotEmpty ? notifier.country : "Страна",
              labelText: "Страна",
      ...
      child: SizedBox(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
              ...
              contentPadding:
                  EdgeInsets.symmetric(horizontal: 16.w, vertical: 14.h),
              hintText: notifier.region.isNotEmpty ? notifier.region : "Регион",
              labelText: "Регион",
              floatingLabelBehavior: FloatingLabelBehavior.auto,
              labelStyle: TextStyle(
                  color: Colors.grey.shade400,
      ...
      child: SizedBox(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
              ...
              contentPadding:
                  EdgeInsets.symmetric(horizontal: 16.w, vertical: 14.h),
              hintText: notifier.descriptionRegion.isNotEmpty
                  ? notifier.descriptionRegion
                  : "Описание среды обитания",
              labelText: "Описание среды обитания",
              floatingLabelBehavior: FloatingLabelBehavior.auto,
              labelStyle: TextStyle(
                  color: Colors.grey.shade400,
                  fontFamily: 'Sora',
        ...
        child: Container(
          decoration: BoxDecoration(
              ...
              image: notifier.profileImage == null
                  ? notifier.plant.image.isNotEmpty
                      ? DecorationImage(
                          image: NetworkImage(
          ...
          height: 160.h,
          child:
              notifier.profileImage != null || notifier.plant.image.isNotEmpty
                  ? const SizedBox()
                  : Icon(
            ...
            children: [
              ...
              Text(
                notifier.fileName != null
                    ...
                    : notifier.plant.model.isNotEmpty
                        ? notifier.plant.model
    ...
    return Center(
      child: SizedBox(
        ...
        child: ElevatedButton(
          onPressed: notifier.plant.image.isEmpty ||
                  notifier.plant.model.isEmpty ||
      ...
      child: SizedBox(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
              ...
              contentPadding:
                  EdgeInsets.symmetric(horizontal: 16.w, vertical: 14.h),
              hintText: notifier.name_ru.isNotEmpty
                  ? notifier.name_ru
                  : "Наименование на русском",
              labelText: "Наименование на русском",
              floatingLabelBehavior: FloatingLabelBehavior.auto,
              labelStyle: TextStyle(
                  color: Colors.grey.shade400,
                  fontFamily: 'Sora',
      ...
      child: SizedBox(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
              ...
              contentPadding:
                  EdgeInsets.symmetric(horizontal: 16.w, vertical: 14.h),
              hintText: notifier.name_latin.isNotEmpty
                  ? notifier.name_latin
                  : "Наименование на латинском",
              labelText: "Наименование на латинском",
              floatingLabelBehavior: FloatingLabelBehavior.auto,
              labelStyle: TextStyle(
                  color: Colors.grey.shade400,
                  fontFamily: 'Sora',
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
              ...
              contentPadding:
                  EdgeInsets.symmetric(horizontal: 16.w, vertical: 14.h),
              hintText:
                  notifier.source.isNotEmpty ? notifier.source : "Источник",
              labelText: "Источник",
              floatingLabelBehavior: FloatingLabelBehavior.auto,
              labelStyle: TextStyle(
                  color: Colors.grey.shade400,
      ...
      child: SizedBox(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
              ...
              contentPadding:
                  EdgeInsets.symmetric(horizontal: 16.w, vertical: 14.h),
              hintText: notifier.origin.isNotEmpty
                  ? notifier.origin
                  : "Происхождение",
      ...
      child: SizedBox(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
              ...
              contentPadding:
                  EdgeInsets.symmetric(horizontal: 16.w, vertical: 14.h),
              hintText: notifier.description.isNotEmpty
                ...
                builder: (BuildContext context, String value, _) {
                  return DropdownButtonFormField(
                    ...
                    hint: Padding(
                      ...
                      child: Text(
                        notifier.dropFamilyValue.value.isNotEmpty
                            ? notifier.dropFamilyValue.value
                            : "Семейство",
                        style: TextStyle(
                            color: notifier.dropFamilyValue.value.isNotEmpty
                                ? Colors.white
                                : Colors.grey.shade400,
                            fontFamily: 'Sora',
                            fontWeight: FontWeight.w500,
                ...
                builder: (BuildContext context, String value, _) {
                  return DropdownButtonFormField(
                    ...
                    hint: Padding(
                      padding: EdgeInsets.only(left: 5.w),
                      child: Text(
                        notifier.dropGenusValue.value.isNotEmpty
                            ? notifier.dropGenusValue.value
                            : "Род",
                        style: TextStyle(
                            color: notifier.dropGenusValue.value.isNotEmpty
                                ? Colors.white
                                : Colors.grey.shade400,
                            fontFamily: 'Sora',
                            fontWeight: FontWeight.w500,
                ...
                builder: (BuildContext context, String value, _) {
                  return DropdownButtonFormField(
                    ...
                    hint: Padding(
                      padding: EdgeInsets.only(left: 5.w),
                      child: Text(
                        notifier.dropPLantTypeValue.value.isNotEmpty
                            ? notifier.dropPLantTypeValue.value
                            : "Тип растения",
                        style: TextStyle(
                            color: notifier.dropPLantTypeValue.value.isNotEmpty
                                ? Colors.white
                                : Colors.grey.shade400,
                            fontFamily: 'Sora',
                            fontWeight: FontWeight.w500,
                ...
                builder: (BuildContext context, String value, _) {
                  return DropdownButtonFormField(
                    ...
                    hint: Padding(
                      padding: EdgeInsets.only(left: 5.w),
                      child: Text(
                        notifier.dropLifeCycleValue.value.isNotEmpty
                            ? notifier.dropLifeCycleValue.value
                            : "Жизненный цикл",
                        style: TextStyle(
                            color: notifier.dropLifeCycleValue.value.isNotEmpty
                                ? Colors.white
                                : Colors.grey.shade400,
                            fontFamily: 'Sora',
                            fontWeight: FontWeight.w500,
                ...
                builder: (BuildContext context, String value, _) {
                  return DropdownButtonFormField(
                    ...
                    hint: Padding(
                      padding: EdgeInsets.only(left: 5.w),
                      child: Text(
                        notifier.dropHabitatValue.value.isNotEmpty
                            ? notifier.dropHabitatValue.value
                            : "Среда обитания",
                        style: TextStyle(
                            color: notifier.dropHabitatValue.value.isNotEmpty
                                ? Colors.white
                                : Colors.grey.shade400,
                            fontFamily: 'Sora',
                            fontWeight: FontWeight.w500,
